...
install-local:
	...
	# pengwin theme (Pengwin’s default)
	### Plymouth theme
	install -d $(DESTDIR)/usr/share/plymouth/themes/pengwin
	$(INSTALL_DATA) $(wildcard pengwin-theme/plymouth/*) $(DESTDIR)/usr/share/plymouth/themes/pengwin
	install -d $(DESTDIR)/usr/share/desktop-base/pengwin-theme
	cd $(DESTDIR)/usr/share/desktop-base/pengwin-theme && ln -s /usr/share/plymouth/themes/pengwin plymouth

	### Login background
	install -d $(DESTDIR)/usr/share/desktop-base/pengwin-theme/login
	$(INSTALL_DATA) $(wildcard pengwin-theme/login/*) $(DESTDIR)/usr/share/desktop-base/pengwin-theme/login

	### Wallpapers
	install -d $(DESTDIR)/usr/share/desktop-base/pengwin-theme/wallpaper/contents/images
	$(INSTALL_DATA) pengwin-theme/wallpaper/metadata.desktop $(DESTDIR)/usr/share/desktop-base/pengwin-theme/wallpaper
	$(INSTALL_DATA) pengwin-theme/wallpaper/gnome-background.xml $(DESTDIR)/usr/share/desktop-base/pengwin-theme/wallpaper
	$(INSTALL_DATA) $(wildcard pengwin-theme/wallpaper/contents/images/*) $(DESTDIR)/usr/share/desktop-base/pengwin-theme/wallpaper/contents/images/
	$(INSTALL_DATA) pengwin-theme/gnome-wp-list.xml $(DESTDIR)/usr/share/gnome-background-properties/debian-pengwin.xml
	# Wallpaper symlink for KDE
	install -d $(DESTDIR)/usr/share/wallpapers
	cd $(DESTDIR)/usr/share/wallpapers && ln -s /usr/share/desktop-base/pengwin-theme/wallpaper pengwin

	### Lockscreen is using the same image as wallpaper
	install -d $(DESTDIR)/usr/share/desktop-base/pengwin-theme/lockscreen/contents/images
	$(INSTALL_DATA) pengwin-theme/wallpaper/metadata.desktop $(DESTDIR)/usr/share/desktop-base/pengwin-theme/lockscreen
	$(INSTALL_DATA) pengwin-theme/wallpaper/gnome-background.xml $(DESTDIR)/usr/share/desktop-base/pengwin-theme/lockscreen
	$(INSTALL_DATA) $(wildcard pengwin-theme/wallpaper/contents/images/*) $(DESTDIR)/usr/share/desktop-base/pengwin-theme/lockscreen/contents/images/

	# Lock screen symlink for KDE
	install -d $(DESTDIR)/usr/share/wallpapers
	cd $(DESTDIR)/usr/share/wallpapers && ln -s /usr/share/desktop-base/pengwin-theme/wallpaper pengwin_wallpaper
